...
import { SidebarContent } from '@root/components/docs-elements/sidebar/sidebar'
import { mainNavLinks } from '@root/components/docs-elements/header'
// import SponsorButton from './sponsor-button'
import useRouteChanged from '@root/hooks/use-route-changed'
import { getRoutes } from '@root/components/docs-elements/layouts/mdx'

const Logo = AiOutlineMenu
