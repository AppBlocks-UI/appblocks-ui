...
const links = [
  {
    icon: DiGithubBadge,
    label: 'GitHub',
    href: 'https://github.com/appblocks_xyz',
  },
  {
    icon: IoLogoTwitter,
    label: 'Twitter',
    href: 'https://twitter.com/appblocks_xyz',
  },
  {
    icon: MdEmail,
    label: 'Email',
    href: 'mailto:appblocks.xyz@gmail.com',
  },
]

const NigeriaFlag = (props: any) => (
  <chakra.svg
...
export const Footer = (props: StackProps) => (
  <VStack as='footer' spacing={4} mt={12} textAlign='center' {...props}>
    <Text fontSize='sm'>
      <span>&copy; AppBlocks {currentYear}</span>
    </Text>
